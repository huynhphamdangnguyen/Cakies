...
const ProductDetail = () => {
  ...
  const [getIdOrder, setIdOrder] = useState(null);
      ...
      <div className="p-3 max-w-7xl m-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-6 h-max">
            ...
            <div>
              ...
              <p className="mt-3 text-gray-600 text-base leading-6 text-justify sm:text-left sm:mt-4">
                ...
                doloremque magni atque laborum suscipit, est aspernatur ab
                consectetur illum expedita. Id et ipsum beatae. Eaque quasi
                repellendus magni iure corporis?
              </p>
              ...
              <p className="text-xl text-black font-semibold sm:text-2xl">
                {products.price}vnd
              </p>
              <div className="mt-4">
        ...
        <div className="text-black/75 mt-12">
          <p>
            ...
            illo. Cum fugit voluptatum inventore quidem placeat. Blanditiis
            illum ea officiis quo illo enim eum vel est fuga non, tenetur
            libero!
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Doloribus,
